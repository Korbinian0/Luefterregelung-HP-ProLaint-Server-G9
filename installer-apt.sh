...
# Move the reinstaller-update-deb.sh script to /root/ and make it executable
cp reinstaller-update-deb.sh /root/reinstaller-update-deb.sh
chmod +x /root/reinstaller-update-deb.sh
