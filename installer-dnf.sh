...
## This script installs the autofan.py script and sets it up as a systemd service on a Fedora-based system.
#################################################################################################################
#!/bin/bash
...
dnf update -y
dnf install -y lm-sensors python3 curl git sshpass
...
# Replace placeholders in autofan.py and autofan-test.py
